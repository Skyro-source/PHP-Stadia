<?php
    ...
    // $resultatCarrousel is provided by gestion_jeux.php (included above)
?>
...
<body id="main">
    ...
    <!-- Bridge: expose the PHP carousel data to JavaScript as a single const -->
    <script>
        const heroGames = <?= json_encode($resultatCarrousel) ?>;
    </script>
    
    <div class="container" id="jeu_principal">
        <div id="hero-info">
            <!-- Placeholders: filled dynamically by carrousel.js using heroGames -->
            <img id="hero-logo" src="" alt="game logo">
            <a href="" id="lien-jouer">
                <div id="bouton_jouer">
        ...
        <div class="container" id="bannière">
            <!-- Slides generated by carrousel.js -->
        </div>
        <div id="hero-buttons">
            <!-- Navigation dots generated by carrousel.js -->
        </div>
    </div>
    ...
    <!-- carrousel.js must come AFTER the heroGames <script> block above -->
